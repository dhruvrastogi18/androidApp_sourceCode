...
public class entrepreneurship extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar = (Toolbar) findViewById(R.id.entrepreneurship_page_toolbar);
        setSupportActionBar(mToolbar);
        getSupportActionBar().setTitle("Entrepreneurship");

        drawerLayout = (DrawerLayout) findViewById(R.id.d_layout);
        actionBarDrawerToggle = new ActionBarDrawerToggle(entrepreneurship.this, drawerLayout, R.string.drawer_open, R.string.drawer_close);
        ...
        String url = "https://i.imgur.com/TFrEdcU.jpg";
