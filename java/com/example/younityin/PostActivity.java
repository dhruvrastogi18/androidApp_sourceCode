...
public class PostActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        UpdatePostButton = (Button) findViewById(R.id.Post_now);
        PostDescription =(EditText) findViewById(R.id.caption);
...
final StorageReference filepath = PostsImagesRefrence.child(ImageUri.getLastPathSegment()+postRandomName+".jpg");
