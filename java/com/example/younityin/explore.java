...
public class explore extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar = (Toolbar) findViewById(R.id.explore_page_toolbar);
       ...
       navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
        ...
        String url = "https://i.imgur.com/yhCPqoT.jpg";
    ...
    {
        Intent whatsappIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://api.whatsapp.com/send?phone=919756102244&text=I+Need+Career+Guidance"));
