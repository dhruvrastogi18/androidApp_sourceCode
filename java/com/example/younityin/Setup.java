...
public class Setup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SaveInformationbuttion = (Button) findViewById(R.id.saveinfo);
        ProfileImage = (CircleImageView) findViewById(R.id.dp);
        ...
        private void SaveAccountSetupInformation()
    {
        ...
        if (TextUtils.isEmpty(country)) {
            ...
            userMap.put("status", "Hey there, i am a proud member of Younity");
